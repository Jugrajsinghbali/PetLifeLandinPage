...
/* src/components/BlogRow.jsx */
import { useRef } from "react"
import { ChevronLeftIcon, ChevronRightIcon } from "@heroicons/react/24/solid"
import BlogCard from "./BlogCard"

export default function BlogRow({ blogs }) {
    ...
    return (
        <div className="relative w-full py-8">
            <h2 className="text-2xl font-bold text-center mb-6">New Content</h2>
            <p className="text-center text-gray-500 mb-4">Contents</p>
